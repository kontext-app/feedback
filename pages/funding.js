...
const Funding = ({ data, title, description }) => {
                          ...
                          <div className="postList">
                             <div className="topContainer">
                                <div className="postListMenu">
                                   <div className="menu">
                                      <div className="text">Issues which are funded wait for developers to pick up the task</div>
                                   </div>
                                    ...
                                    <a key={i} class="postLink">
                                       <div class="body">
                                          ...
                                          <div class="statusStale">
                                             <div class="uppercaseHeader postStatus planned">{blog.category} Request</div>
                                          </div>
